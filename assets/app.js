...
},{"./pages/Create.js":5,"./pages/Home.js":6,"./pages/Login.js":7,"./pages/Logout.js":8,"./pages/Register.js":9,"./pages/User.js":10,"mithril":11}],3:[function(require,module,exports){
var m = require('mithril');

var Auth = module.exports = {
  token: m.prop(localStorage.token),
  admin:m.prop(localStorage.admin),
  ...
  login: function(email, password){
    return m.request({
      ...
      unwrapSuccess: function(res) {
        ...
        localStorage.admin=res.user.admin;
        Auth.admin(res.user.admin);
        return res.token;
      }
    })
    .then(this.token);
...
},{"../components/Navbar.js":1,"../models/Auth.js":3,"../models/Helper.js":4,"mithril":11}],7:[function(require,module,exports){
var m = require('mithril');
...
},{"../components/Navbar.js":1,"../models/Auth.js":3,"mithril":11}],8:[function(require,module,exports){
var m = require('mithril');
...
},{"../models/Auth.js":3,"mithril":11}],9:[function(require,module,exports){
var m = require('mithril');
